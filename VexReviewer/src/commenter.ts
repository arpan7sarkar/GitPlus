...
export const COMMENT_GREETING = `${getInput('bot_icon')}   VexReview`

export const COMMENT_TAG = '<!-- This is an auto-generated comment by VexReview -->'

export const COMMENT_REPLY_TAG =
  '<!-- This is an auto-generated reply by VexReview -->'

export const SUMMARIZE_TAG =
  '<!-- This is an auto-generated comment: summarize by VexReview -->'

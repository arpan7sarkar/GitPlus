...
const ignoreKeyword = '@vexreview: ignore'
...
`
  ...
  if (options.disableReleaseNotes === false) {
    ...
    if (releaseNotesResponse === '') {
      ...
      let message = '### Summary by VexReview\n\n'
...
This review was generated by **VexReview**, an AI-powered code reviewer built for the CodebaseGPT ecosystem.
</details>
`
...
### Chat with VexReview Bot (\`@vexreview\`)
- Reply on review comments left by this bot to ask follow-up questions. A review comment is a comment on a diff or a file.
- Invite the bot into a review comment chain by tagging \`@vexreview\` in a reply.
...
- Add \`@vexreview: ignore\` anywhere in the PR description to pause further reviews from the bot.
